...
{ 
	...
	// Mob games button
	this.mobGames = game.add.button(240,300, 'mobGames',
								   this.visitMobGames, this);
...
visitMobGames: function() 
{
	...
	// open in a new window  (this might be blocked by popup blockers)  // window.open("http://mobgames.us", "_blank");
},
